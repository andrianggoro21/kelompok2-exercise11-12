...
const BoxHome = () => {
  return (
    <Stack p="10%" gap="2em" alignItems="center">
      <Image src="/images/logo.png" w="80%"></Image>
      <Heading as="h2">See what's happening in the world right now</Heading>
      <Stack w="full">
        ...
        <Text fontSize="0.6em" fontWeight="medium" te>
          ...
          <Text as="span" color="cyan.700"> Terms of Service </Text>and
          <Text as="span" color="cyan.700"> Privacy Policy </Text>,
          <Text as="span" color="cyan.700"> Cookies Use.</Text>
        </Text>
